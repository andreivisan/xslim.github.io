...
xmlns:fn="http://www.w3.org/2005/xpath-functions">
  ...
  <xsl:template match="GUIDE">
      <HTML>
          <HEAD>
              ...
              <LINK HREF="http://kalapun.com/favicon.png" type="image/x-icon"
                    rel="shortcut icon"/>
  ...
  <xsl:template match="a|address|blockquote|br|center|cite|code|dd|div|dl|dt|em|hr|i|img|li|ol|p|pre|span|table|td|th|tr|ul|var|A|ADDRESS|BLOCKQUOTE|BR|CENTER|CITE|CODE|DD|DIV|DL|DT|EM|HR|I|LI|OL|P|PRE|SPAN|TABLE|TD|TH|TR|UL|VAR|b|strong">
